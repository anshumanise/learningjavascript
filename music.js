...
function main() {
  // Crete your class media with proper constructor properties and methods as mentioned.
    class Media{
        ...
        this.title = title;      // Initialize parent properties
        this.artist = artist;
  ...
  //Create a Class Song extending the Media with proper constructor ,properties and methods
    class Song extends Media {
        ...
        super(title, artist, duration); // Call the parent constructor
        this.album = album;
        this.genre = genre;
    }
  ...
  //Create class PopSong and PockSong using Song class
    class PopSong extends Song {
        ...
        super(title, artist, duration, album, genre); // Call the parent constructor
  ...
  //Create NewsPodcast and ComedyPodcast using the Podcast class.
    class NewsPodcast extends Podcast {
        ...
        super(title, artist, duration, host, topic);   // Call the parent constructor
        this.source = source;
    }   
